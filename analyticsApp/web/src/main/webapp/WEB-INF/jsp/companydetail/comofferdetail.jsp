...
<head>
    ...
    <script type="text/javascript" src="js/sys/cmofdt.js"></script>
    <script>
        $(document).ready(function(){
            var value= ${tablist};
            CMOFDT.DownloadInfo=value[0].PriceDownload;
        });
    </script>
    <script>
...
<div class="big_box">
	<div class="details_top_nav">
		<c:forEach var="dt_li" items="${tablist}">
			<li class="details_nav" id="${dt_li.Remark}_dt" idxid="${dt_li.Remark}" wdstr="${dt_li.CycleStr}" onclick="CMOFDT.changeLi('${dt_li.Remark}_dt');"><a>${dt_li.NAME}</a></li>
		</c:forEach>
	...
	<div class="details_top">
                ...
                <div class="calendar">
                    ...
                    <div class="calendar_ss"><a onclick="CMOFDT.search();">搜索</a></div>
                </div>
