...
<script>
    priceCurrArray = ${chinaPriceArray};
...
<div class="tb">
    <div class="tab_h">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr class="tb_title">
                <th style="width:4%"></th>
                <th style="width:24%;cursor: pointer" onclick="sort_price(this,'PubDate','unchina_price');">
                    <span>日期</span>
                    <span class="ascending_box"><a style="cursor: pointer" class="ascending01"></a><a style="cursor: pointer" class="descending01"></a></span>
                </th>
                <th style="width:24%;cursor: pointer" onclick="sort_price(this,'CodeName','unchina_price');">
                    <span>类型</span>
                    <span class="ascending_box"><a style="cursor: pointer" class="ascending01"></a><a style="cursor: pointer" class="descending01"></a></span>
                </th>
                <th style="width:24%;cursor: pointer" onclick="sort_price(this,'minChange','unchina_price');">
                    <span>涨跌</span>
                    <span class="ascending_box"><a style="cursor: pointer" class="ascending01"></a><a style="cursor: pointer" class="descending01"></a></span>
                </th>
                <th style="width:24%;cursor: pointer" onclick="sort_price(this,'Name','unchina_price');">
                    <span>单位</span>
                    <span class="ascending_box"><a style="cursor: pointer" class="ascending01"></a><a style="cursor: pointer" class="descending01"></a></span>
                </th>
            </tr>
    ...
    <div class="tab_b" style="height: 230">
        <table width="100%"  border="0" cellpadding="0" cellspacing="0" id="abroad_price">
